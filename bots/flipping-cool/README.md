...
This is the first robot project in this monorepo.
...
- `firmware/`: Embedded code for ESC, receiver, sensors, or control
- `software/`: Simulation, tooling, telemetry, or host-side logic
